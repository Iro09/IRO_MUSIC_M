...
LAHSAN = """ʙʟᴀᴄᴋʟɪsᴛ ғᴇᴀᴛᴜʀᴇ [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs]
 **<u>ʙʟᴀᴄᴋʟɪsᴛ ᴄʜᴀᴛ :</u>**
...
SUDO = """ **sᴜᴅᴏᴇʀs ᴀɴᴅ ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs :**
...
GBAN = """ **<u>ɢʙᴀɴ ғᴇᴀᴛᴜʀᴇ</u>** [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs] :
...
PASTE = "/paste - To Paste Replied Text Or Document To A Pastebin"

PIPE = """**THIS MODULE IS ONLY FOR DEVS**
...
PROXY = """/proxy - Get socks5 proxy which you can use with telegram or other things"""

QUOTLY = """/q - To quote a message.
/q [INTEGER] - To quote more than 1 messages.
/q r - to quote a message with it's reply
Use .q to quote using userbot"""

REDDIT = """/reddit [query] - results something from reddit"""
...
TELE = """/telegraph [Page name]: Paste styled text on telegraph."""

URL = """/short - To Short a url. Use **/short url coustom** to get coustom link.
